...
import { IonContent, IonHeader, IonToolbar, IonTitle, IonButton, IonButtons, IonIcon, IonMenu, IonMenuButton, IonList, IonItem, IonLabel, IonMenuToggle } from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [
    ...
    IonMenu, IonMenuButton, IonList, IonItem, IonLabel, IonMenuToggle
  ],
